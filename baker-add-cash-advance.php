...
if(isset($_POST["submit"])){
  ...
  if($database->checkCashAdavnceIfAlreadyExists($branch_id,$name,$amount,$created_at)){
    
    echo 'Cash already added..';

  } else {

      $database->insertBakerCashAdvance($branch_id,$name,$amount,$created_at);
            ...
            <div class="modal-dialog">
                ...
                <a href="baker-cash-advance.php"><span class="glyphicon glyphicon-chevron-left"></span>Return</a>
                    <div class="modal-header">
                        <h2 class="modal-title">Add Cash Advance</h2>
