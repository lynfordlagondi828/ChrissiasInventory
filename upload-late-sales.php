...
if(isset($_POST["submit"])){
    ...
    $quantity,$total,$unsold_goods,$price,$pullout,$sales,$created_at);
    $message = "late sales/products added...";
...
<div class="row">
            <div class="modal-dialog">
                ...
                <a href="baker-product.php"><span class="glyphicon glyphicon-chevron-left"></span>Return</a>
                    <div class="modal-header">
                        <h2 class="modal-title">Upload late Sales/Products</h2>
            ...
            <button class="btn btn-success" name="submit"><span class="glyphicon glyphicon-ok"> SAVE</spa></button>
